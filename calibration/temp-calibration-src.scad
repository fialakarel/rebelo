// Customizable Temp Calibration Tower (fixed!)
//  by eibwen, published Jul 7, 2015
...
NumberOfBlocks = 10;
Labels=["195","200","205","210","215","220","225","230","235","240"];
...
fn_override = 100; //[0:Default, 24:Better (24), 50:High quality (50), 100:Super HQ (100)]
$fn = fn_override;
